...
#define PRINT_SCRIPTERR (RSDK::Dev::PrintModes)4
    ...
    if (opcode <= 0) {
        ...
        for (int32 i = 0; i < opcodeSize; ++i) {
            ...
            if (StrComp(funcName, "TypeName")) {
                funcName[0] = 0;
                AppendIntegerToString(funcName, GameObject::Find(arrayStr));
            }

            // Eg: temp0 = SfxName[Jump]
            if (StrComp(funcName, "SfxName")) {
                funcName[0] = 0;
                AppendIntegerToString(funcName, RSDKTable->GetSfx(arrayStr));
                break;
            }
            ...
            if (StrComp(funcName, "AchievementName")) {
                funcName[0] = '0';
                funcName[1] = 0;
                int cnt = Mod::Achievements::GetCount();
                int32 a = 0;
                for (; a < cnt; ++a) {
                    char buf[0x40];
                    String namestr{};
                    Mod::Achievements::GetInfo(a, &namestr, nullptr, nullptr, nullptr);
                    int32 pos       = 0;

                    for (int strpos = 0; strpos < namestr.length; ++strpos) {
                        if (namestr.chars[strpos] != ' ')
                            buf[pos++] = (char)namestr.chars[strpos];
                    }
                    buf[pos] = 0;
...
void RSDK::Legacy::v4::CheckCaseNumber(char *text)
{
    ...
    if (FindStringToken(caseString, "[", 1) >= 0) {
        ...
        if (StrComp(caseValue, "TypeName")) {
            caseValue[0] = 0;
            AppendIntegerToString(caseValue, GameObject::Find(arrayStr));
        }

        // Eg: temp0 = SfxName[Jump]
        if (StrComp(caseValue, "SfxName")) {
            caseValue[0] = 0;
            AppendIntegerToString(caseValue, RSDKTable->GetSfx(arrayStr));
        }
                ...
                case PARSEMODE_FUNCTION:
                    ...
                    if (scriptText[0]) {
                        if (StrComp(scriptText, "endevent")) {
                            ...
                            if (FindStringToken(scriptText, "STANDARD", 1) == -1
                                && FindStringToken(scriptText, "SW_RENDERING", 1) == -1
#if LEGACY_RETRO_USE_HAPTICS
        ...
        for (int32 i = 0; i < opcodeSize; ++i) {
            ...
            if (opcodeType == SCRIPTVAR_VAR) {
                ...
                switch (scriptCode[scriptCodePtr++]) {
                    case VARARR_NONE: arrayVal = sceneInfo->entitySlot; break;
                    case VARARR_ARRAY:
                    ...
                    case VARARR_ENTNOPLUS1:
                        if (scriptCode[scriptCodePtr++] == 1)
                            arrayVal = scriptEng.arrayPosition[scriptCode[scriptCodePtr++]] + sceneInfo->entitySlot;
                        else
                            arrayVal = scriptCode[scriptCodePtr++] + sceneInfo->entitySlot;
                        break;
                    case VARARR_ENTNOMINUS1:
                        if (scriptCode[scriptCodePtr++] == 1)
                            arrayVal = sceneInfo->entitySlot - scriptEng.arrayPosition[scriptCode[scriptCodePtr++]];
                        else
                            arrayVal = sceneInfo->entitySlot - scriptCode[scriptCodePtr++];
                        break;
                    default: break;
                }
                ...
                switch (scriptCode[scriptCodePtr++]) {
                    ...
                    case VAR_OBJECTGROUPID: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->group;
                        break;
                    }
                    case VAR_OBJECTTYPE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->classID;
                        break;
                    }
                    case VAR_OBJECTPROPERTYVALUE: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->propertyValue;
                        break;
                    }
                    case VAR_OBJECTXPOS: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->position.x;
                        break;
                    }
                    case VAR_OBJECTYPOS: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->position.y;
                        break;
                    }
                    case VAR_OBJECTIXPOS: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->position.x >> 16;
                        break;
                    }
                    case VAR_OBJECTIYPOS: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->position.y >> 16;
                        break;
                    }
                    case VAR_OBJECTXVEL: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->velocity.x;
                        break;
                    }
                    case VAR_OBJECTYVEL: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->velocity.y;
                        break;
                    }
                    case VAR_OBJECTSPEED: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->groundVel;
                        break;
                    }
                    case VAR_OBJECTSTATE: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->state;
                        break;
                    }
                    case VAR_OBJECTROTATION: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->rotation;
                        break;
                    }
                    case VAR_OBJECTSCALE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->scale.x;
                        break;
                    }
                    case VAR_OBJECTPRIORITY: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->priority;
                        break;
                    }
                    case VAR_OBJECTDRAWORDER: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->drawGroup;
                        break;
                    }
                    case VAR_OBJECTDIRECTION: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->direction;
                        break;
                    }
                    case VAR_OBJECTINKEFFECT: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->inkEffect;
                        break;
                    }
                    case VAR_OBJECTALPHA: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->alpha;
                        break;
                    }
                    case VAR_OBJECTFRAME: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->frame;
                        break;
                    }
                    case VAR_OBJECTANIMATION: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->animation;
                        break;
                    }
                    case VAR_OBJECTPREVANIMATION: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->prevAnimation;
                        break;
                    }
                    case VAR_OBJECTANIMATIONSPEED: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->animationSpeed;
                        break;
                    }
                    case VAR_OBJECTANIMATIONTIMER: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->animationTimer;
                        break;
                    }
                    case VAR_OBJECTANGLE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->angle;
                        break;
                    }
                    case VAR_OBJECTLOOKPOSX: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->lookPosX;
                        break;
                    }
                    case VAR_OBJECTLOOKPOSY: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->lookPosY;
                        break;
                    }
                    case VAR_OBJECTCOLLISIONMODE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->collisionMode;
                        break;
                    }
                    case VAR_OBJECTCOLLISIONPLANE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->collisionPlane;
                        break;
                    }
                    case VAR_OBJECTCONTROLMODE: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->controlMode;
                        break;
                    }
                    case VAR_OBJECTCONTROLLOCK: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->controlLock;
                        break;
                    }
                    case VAR_OBJECTPUSHING: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->pushing;
                        break;
                    }
                    case VAR_OBJECTVISIBLE: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->visible;
                        break;
                    }
                    case VAR_OBJECTTILECOLLISIONS: {
                        scriptEng.operands[i] = GameObject::Get(arrayVal)->tileCollisions;
                        break;
                    }
                    case VAR_OBJECTINTERACTION: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->objectInteractions;
                        break;
                    }
                    case VAR_OBJECTGRAVITY: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->gravity;
                        break;
                    }
                    case VAR_OBJECTUP: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->up;
                        break;
                    }
                    case VAR_OBJECTDOWN: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->down;
                        break;
                    }
                    case VAR_OBJECTLEFT: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->left;
                        break;
                    }
                    case VAR_OBJECTRIGHT: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->right;
                        break;
                    }
                    case VAR_OBJECTJUMPPRESS: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->jumpPress;
                        if (scriptEng.operands[i])
                            printf("");
                        break;
                    }
                    case VAR_OBJECTJUMPHOLD: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->jumpHold;
                        break;
                    }
                    case VAR_OBJECTSCROLLTRACKING: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->scrollTracking;
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORL: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->floorSensors[0];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORC: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->floorSensors[1];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORR: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->floorSensors[2];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORLC: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->floorSensors[3];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORRC: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->floorSensors[4];
                        break;
                    }
                    case VAR_OBJECTCOLLISIONLEFT: {
                        AnimationFile *animFile = objectScriptList[GameObject::Get(arrayVal)->classID].animFile;
                        RSDKv4Object* ent = GameObject::Get<RSDKv4Object>(arrayVal);
                        if (animFile) {
                    ...
                    case VAR_OBJECTOUTOFBOUNDS: {
                        ...
                        RSDKv4Object *entPtr = GameObject::Get<RSDKv4Object>(arrayVal);
                        int32 x        = entPtr->position.x >> 16;
                        int32 y        = entPtr->position.y >> 16;
                    ...
                    case VAR_OBJECTSPRITESHEET: {
                        scriptEng.operands[i] = objectScriptList[GameObject::Get(arrayVal)->classID].spriteSheetID;
                        break;
                    }
                    case VAR_OBJECTVALUE0: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[0];
                        break;
                    }
                    case VAR_OBJECTVALUE1: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[1];
                        break;
                    }
                    case VAR_OBJECTVALUE2: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[2];
                        break;
                    }
                    case VAR_OBJECTVALUE3: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[3];
                        break;
                    }
                    case VAR_OBJECTVALUE4: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[4];
                        break;
                    }
                    case VAR_OBJECTVALUE5: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[5];
                        break;
                    }
                    case VAR_OBJECTVALUE6: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[6];
                        break;
                    }
                    case VAR_OBJECTVALUE7: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[7];
                        break;
                    }
                    case VAR_OBJECTVALUE8: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[8];
                        break;
                    }
                    case VAR_OBJECTVALUE9: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[9];
                        break;
                    }
                    case VAR_OBJECTVALUE10: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[10];
                        break;
                    }
                    case VAR_OBJECTVALUE11: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[11];
                        break;
                    }
                    case VAR_OBJECTVALUE12: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[12];
                        break;
                    }
                    case VAR_OBJECTVALUE13: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[13];
                        break;
                    }
                    case VAR_OBJECTVALUE14: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[14];
                        break;
                    }
                    case VAR_OBJECTVALUE15: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[15];
                        break;
                    }
                    case VAR_OBJECTVALUE16: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[16];
                        break;
                    }
                    case VAR_OBJECTVALUE17: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[17];
                        break;
                    }
                    case VAR_OBJECTVALUE18: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[18];
                        break;
                    }
                    case VAR_OBJECTVALUE19: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[19];
                        break;
                    }
                    case VAR_OBJECTVALUE20: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[20];
                        break;
                    }
                    case VAR_OBJECTVALUE21: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[21];
                        break;
                    }
                    case VAR_OBJECTVALUE22: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[22];
                        break;
                    }
                    case VAR_OBJECTVALUE23: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[23];
                        break;
                    }
                    case VAR_OBJECTVALUE24: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[24];
                        break;
                    }
                    case VAR_OBJECTVALUE25: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[25];
                        break;
                    }
                    case VAR_OBJECTVALUE26: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[26];
                        break;
                    }
                    case VAR_OBJECTVALUE27: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[27];
                        break;
                    }
                    case VAR_OBJECTVALUE28: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[28];
                        break;
                    }
                    case VAR_OBJECTVALUE29: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[29];
                        break;
                    }
                    case VAR_OBJECTVALUE30: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[30];
                        break;
                    }
                    case VAR_OBJECTVALUE31: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[31];
                        break;
                    }
                    case VAR_OBJECTVALUE32: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[32];
                        break;
                    }
                    case VAR_OBJECTVALUE33: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[33];
                        break;
                    }
                    case VAR_OBJECTVALUE34: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[34];
                        break;
                    }
                    case VAR_OBJECTVALUE35: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[35];
                        break;
                    }
                    case VAR_OBJECTVALUE36: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[36];
                        break;
                    }
                    case VAR_OBJECTVALUE37: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[37];
                        break;
                    }
                    case VAR_OBJECTVALUE38: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[38];
                        break;
                    }
                    case VAR_OBJECTVALUE39: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[39];
                        break;
                    }
                    case VAR_OBJECTVALUE40: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[40];
                        break;
                    }
                    case VAR_OBJECTVALUE41: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[41];
                        break;
                    }
                    case VAR_OBJECTVALUE42: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[42];
                        break;
                    }
                    case VAR_OBJECTVALUE43: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[43];
                        break;
                    }
                    case VAR_OBJECTVALUE44: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[44];
                        break;
                    }
                    case VAR_OBJECTVALUE45: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[45];
                        break;
                    }
                    case VAR_OBJECTVALUE46: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[46];
                        break;
                    }
                    case VAR_OBJECTVALUE47: {
                        scriptEng.operands[i] = GameObject::Get<RSDKv4Object>(arrayVal)->values[47];
                        break;
                    }
                    ...
                    case VAR_STAGELISTSIZE: scriptEng.operands[i] = sceneInfo->listCategory[sceneInfo->activeCategory].sceneCount; break;
        ...
        for (int32 i = 0; i < opcodeSize; ++i) {
            ...
            if (opcodeType == SCRIPTVAR_VAR) {
                ...
                switch (scriptCode[scriptCodePtr++]) {
                    ...
                    case VAR_OBJECTGROUPID: {
                        GameObject::Get(arrayVal)->groupID = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTTYPE: {
                        GameObject::Get(arrayVal)->type = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTPROPERTYVALUE: {
                        GameObject::Get(arrayVal)->propertyValue = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTXPOS: {
                        GameObject::Get(arrayVal)->xpos = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTYPOS: {
                        GameObject::Get(arrayVal)->ypos = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTIXPOS: {
                        GameObject::Get(arrayVal)->xpos = scriptEng.operands[i] << 16;
                        break;
                    }
                    case VAR_OBJECTIYPOS: {
                        GameObject::Get(arrayVal)->ypos = scriptEng.operands[i] << 16;
                        break;
                    }
                    case VAR_OBJECTXVEL: {
                        GameObject::Get(arrayVal)->xvel = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTYVEL: {
                        GameObject::Get(arrayVal)->yvel = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTSPEED: {
                        GameObject::Get(arrayVal)->speed = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTSTATE: {
                        GameObject::Get(arrayVal)->state = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTROTATION: {
                        GameObject::Get(arrayVal)->rotation = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTSCALE: {
                        GameObject::Get(arrayVal)->scale = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTPRIORITY: {
                        GameObject::Get(arrayVal)->priority = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTDRAWORDER: {
                        GameObject::Get(arrayVal)->drawOrder = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTDIRECTION: {
                        GameObject::Get(arrayVal)->direction = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTINKEFFECT: {
                        GameObject::Get(arrayVal)->inkEffect = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTALPHA: {
                        GameObject::Get(arrayVal)->alpha = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFRAME: {
                        GameObject::Get(arrayVal)->frame = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTANIMATION: {
                        GameObject::Get(arrayVal)->animation = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTPREVANIMATION: {
                        GameObject::Get(arrayVal)->prevAnimation = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTANIMATIONSPEED: {
                        GameObject::Get(arrayVal)->animationSpeed = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTANIMATIONTIMER: {
                        GameObject::Get(arrayVal)->animationTimer = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTANGLE: {
                        GameObject::Get(arrayVal)->angle = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTLOOKPOSX: {
                        GameObject::Get(arrayVal)->lookPosX = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTLOOKPOSY: {
                        GameObject::Get(arrayVal)->lookPosY = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTCOLLISIONMODE: {
                        GameObject::Get(arrayVal)->collisionMode = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTCOLLISIONPLANE: {
                        GameObject::Get(arrayVal)->collisionPlane = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTCONTROLMODE: {
                        GameObject::Get(arrayVal)->controlMode = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTCONTROLLOCK: {
                        GameObject::Get(arrayVal)->controlLock = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTPUSHING: {
                        GameObject::Get(arrayVal)->pushing = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVISIBLE: {
                        GameObject::Get(arrayVal)->visible = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTTILECOLLISIONS: {
                        GameObject::Get(arrayVal)->tileCollisions = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTINTERACTION: {
                        GameObject::Get(arrayVal)->objectInteractions = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTGRAVITY: {
                        GameObject::Get(arrayVal)->gravity = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTUP: {
                        GameObject::Get(arrayVal)->up = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTDOWN: {
                        GameObject::Get(arrayVal)->down = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTLEFT: {
                        GameObject::Get(arrayVal)->left = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTRIGHT: {
                        GameObject::Get(arrayVal)->right = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTJUMPPRESS: {
                        GameObject::Get(arrayVal)->jumpPress = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTJUMPHOLD: {
                        GameObject::Get(arrayVal)->jumpHold = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTSCROLLTRACKING: {
                        GameObject::Get(arrayVal)->scrollTracking = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORL: {
                        GameObject::Get(arrayVal)->floorSensors[0] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORC: {
                        GameObject::Get(arrayVal)->floorSensors[1] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORR: {
                        GameObject::Get(arrayVal)->floorSensors[2] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORLC: {
                        GameObject::Get(arrayVal)->floorSensors[3] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTFLOORSENSORRC: {
                        GameObject::Get(arrayVal)->floorSensors[4] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTCOLLISIONLEFT: {
                        break;
                    ...
                    case VAR_OBJECTSPRITESHEET: {
                        objectScriptList[GameObject::Get(arrayVal)->type].spriteSheetID = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE0: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[0] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE1: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[1] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE2: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[2] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE3: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[3] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE4: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[4] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE5: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[5] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE6: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[6] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE7: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[7] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE8: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[8] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE9: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[9] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE10: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[10] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE11: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[11] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE12: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[12] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE13: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[13] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE14: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[14] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE15: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[15] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE16: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[16] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE17: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[17] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE18: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[18] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE19: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[19] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE20: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[20] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE21: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[21] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE22: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[22] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE23: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[23] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE24: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[24] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE25: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[25] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE26: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[26] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE27: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[27] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE28: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[28] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE29: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[29] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE30: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[30] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE31: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[31] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE32: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[32] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE33: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[33] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE34: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[34] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE35: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[35] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE36: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[36] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE37: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[37] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE38: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[38] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE39: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[39] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE40: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[40] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE41: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[41] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE42: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[42] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE43: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[43] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE44: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[44] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE45: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[45] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE46: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[46] = scriptEng.operands[i];
                        break;
                    }
                    case VAR_OBJECTVALUE47: {
                        GameObject::Get<RSDKv4Object>(arrayVal)->values[47] = scriptEng.operands[i];
                        break;
                    }
